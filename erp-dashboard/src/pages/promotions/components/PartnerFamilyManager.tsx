...
export const PartnerFamilyManager = ({ selectedCodes, onSelectionChange }: PartnerFamilyManagerProps) => {
    ...
    return (
        <div className="space-y-6">
            {/* Header Section */}
            <div className="bg-gradient-to-br from-sage-50 via-sage-50 to-purple-50 rounded-xl p-6 border border-sage-100 shadow-sm">
                <div className="flex items-start justify-between mb-3">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-2.5 bg-white text-sage-700 rounded-lg hover:bg-sage-50 transition-all shadow-sm border border-sage-200 font-medium"
                    >
                        <Settings className="w-4 h-4" />
                        Gérer les Familles
                    </button>
                </div>
                <div className="flex items-start gap-2 bg-sage-100/50 rounded-lg p-3 border border-sage-200">
                    <Info className="w-4 h-4 text-sage-700 mt-0.5 flex-shrink-0" />
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="relative flex-1">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 outline-none transition-all text-sm"
                                value={search}
                        ...
                        <div className="flex items-center gap-2">
                            <button
                                ...
                                className="px-3 py-2.5 text-sm font-medium text-sage-700 bg-sage-50 rounded-lg hover:bg-sage-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                Tout sélectionner
                            </button>
                            <button
                ...
                <div className="px-4 py-3 bg-gray-50 border-b border-gray-200">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            <div className="px-3 py-1 bg-sage-100 text-sage-700 rounded-full text-sm font-semibold">
                    ...
                    {loading ? (
                        <div className="flex items-center justify-center py-12">
                            <div className="text-center">
                                <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-sage-500 mx-auto mb-2"></div>
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="flex items-center gap-3 text-xs text-gray-500">
                                                    ...
                                                    <span className={`flex items-center gap-1 ${
                                                        isSelected ? 'text-sage-600 font-medium' : ''
                                                    }`}>
