        ...
        processes: [
            ...
            },
            {
                ...
                actions: [
                    ...
                    { id: 'business-natures',   label: 'Business Natures',    route: '/routing/business-natures',  icon: BookOpen  },
                    { id: 'geo-governance-disp',label: 'Gouvernance Géo',     route: '/routing/geo-governance',    icon: Globe     },
                ],
            },
            {
                id: 'expeditions',
        ...
        processes: [
            ...
            },
            {
                ...
                actions: [
                    ...
                    { id: 'price-channels',  label: 'Canaux de Vente',   route: '/pricing/channels',    icon: Radio     },
                    ...
                    { id: 'chronologies',    label: 'Chronologies',      route: '/pricing/chronologies', icon: Clock    },
                ],
            },
            {
                id: 'promotions',
                label: 'Promotions & Merchandising',
                description: 'Campagnes, familles produits/partenaires et boosts catalogue',
                route: '/promotions',
                icon: Tag,
                actions: [
                    { id: 'promo-all',    label: 'Toutes les campagnes',  route: '/promotions',                  icon: ListTodo   },
                    { id: 'promo-pf',     label: 'Familles Produits',     route: '/promotions/product-families', icon: Package    },
                    { id: 'promo-paf',    label: 'Familles Partenaires',  route: '/promotions/partner-families', icon: Users      },
                    { id: 'promo-boosts', label: 'Boosts Catalogue',      route: '/promotions/boosts',           icon: Star       },
                ],
            },
            {
                id: 'ventes',
                label: 'Ventes & Commandes',
                description: 'Devis, commandes clients et livraisons',
                route: '/orders',
                icon: ShoppingCart,
                actions: [
                    { id: 'vente-order-create', label: 'Nouvelle Commande',    route: '/orders',                  icon: FilePlus      },
                    { id: 'vente-order-list',   label: 'Liste Commandes',      route: '/orders',                  icon: List          },
                    { id: 'vente-validation',   label: 'Validation Livraison', route: '/adv/validation',          icon: CheckCircle2  },
                    { id: 'vente-preparations', label: 'Préparations',         route: '/magasinier/preparations', icon: ClipboardList },
                    { id: 'vente-adv-dash',     label: 'Tableau de Bord ADV',  route: '/adv',                     icon: BarChart3     },
                ],
            },
        ],
    },
