    ...
    categories: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            id: 'base:tiers:client-groups',
            label: 'Groupes Clients',
            route: '/partners/client-groups',
            permission: 'admin.master.customers',
            icon: Tag,
            description: 'Gérer les groupes de consolidation partenaires',
            keywords: ['groupe', 'client', 'group', 'segmentation', 'bim', 'label'],
          },
        ],
      },
    ],
    ...
    categories: [
      {
        ...
        items: [
          ...
          { id: 'tv-agent:cockpit', label: 'Cockpit Télévendeur', route: '/telesales/cockpit', description: 'Appel en cours : fiche client, qualification et commande sur un seul écran', keywords: ['cockpit', 'appel', 'fiche', 'commande'] },
          { id: 'tv-agent:planning', label: 'Semainier / Planning', route: '/telesales/planning', description: 'Planifier un appel futur, semainier', keywords: ['planning', 'semainier', 'appel'] },
    ...
    categories: [
      {
        ...
        items: [
          ...
          {
            id: 'gcom:bons-commande',
            label: 'Bons de commande',
            route: '/gcom/bons-commande',
            icon: ClipboardList,
            description: 'BC GCOM — création, conversion en BL/Facture, annulation',
